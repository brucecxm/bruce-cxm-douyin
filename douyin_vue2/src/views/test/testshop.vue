            ...
            <div class="meum">
                <div class="box1" v-for="(meum, index) in meumbox" :key="index">
                    <div class="contentmen">
                        <img :src="meum.menuImg" alt="" class="menu-img" @click="go(meum.hrefurl)">
                        <div class="menucont">{{ meum.menuName }}</div>
                    </div>
                </div>
            ...
            <div class="nav">
                <div class="box2" v-for="(nav, index) in navbox" :key="index">
                    <div class="contentnav">
                        <img :src="nav.navImg" alt="" class="nav-img">
                        <div class="nav-name">{{ nav.navName }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="main">
                <div class="boxm" v-for="(item, index) in mainbox" :key="index" @click="goshopdetail(item.shopId)">
                    <div class="contentmain">
                        <img :src="item.shopImg" alt="" class="nav-img">
                        <div class="shop-info">{{ item.shopInfo }}</div>
                    </div>
                </div>
