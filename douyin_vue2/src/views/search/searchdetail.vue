<template>
    <div class="search-detail">
        <div class="search-bar">
            <input type="text" placeholder="搜索" v-model="searchQuery" @input="onSearch" />
            <button>搜索</button>
        </div>
        <div class="tab-bar">
            <span :class="{ 'active': selectedTab === '综合' }" @click="selectTab('综合')">综合</span>
            <span :class="{ 'active': selectedTab === '视频' }" @click="selectTab('视频')">视频</span>
            <span :class="{ 'active': selectedTab === '用户' }" @click="selectTab('用户')">用户</span>
            <span :class="{ 'active': selectedTab === '经验' }" @click="selectTab('经验')">经验</span>
            <span :class="{ 'active': selectedTab === 'AI搜' }" @click="selectTab('AI搜')">AI搜</span>
        </div>
