<template>
    <div style="width: 100%; height: 100%;">
        <div class="coupon-header" style="background-color: #fff8e1; padding: 10px;">
            <ul style="list-style-type: disc; padding-left: 20px; margin: 0; font-size: 0.5rem;">
                <li>每种优惠券每月只能领取一次。</li>
        ...
        <div v-for="coupon in coupons" :key="coupon.id" class="coupon-item">
            ...
            <div class="coupon-details">
                <span class="coupon-amount" style="font-size: 0.5rem; color: #f50057;">{{ coupon.amount }}</span>
                <span class="coupon-description" style="font-size: 0.5rem; ">{{ coupon.description }}</span>
            </div>
