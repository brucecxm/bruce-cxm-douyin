<template>
    <div class="settings" style="width: 414px; height: 896px;">
        ...
        <div class="settings-group">
            <div class="settings-item" v-for="(item, index) in accountSettings" :key="index">
                <i :class="item.icon"></i>
        ...
        <div class="settings-group">
            <div class="settings-item" v-for="(item, index) in generalSettings" :key="index">
                <i :class="item.icon"></i>
                <span>{{ item.label }}</span>
                <i class="fas fa-chevron-right"></i>
            </div>
        ...
        <div class="settings-group">
            <div class="settings-item" v-for="(item, index) in aboutSettings" :key="index">
                <i :class="item.icon"></i>
                <span>{{ item.label }}</span>
                <i class="fas fa-chevron-right"></i>
            </div>
