<template>
    <div class="chat-container">
        ...
        <div class="chat-box">
            <ul id="chat">
                <li v-for="(message, index) in messages" :key="index"
                    :class="['chat-message', message.type === 'JOIN' ? 'join-message' : (message.sender === username ? 'user-message' : 'friend-message')]">
        ...
        <div class="message-input">
            <input v-model="message" placeholder="Type a message" class="input-field" />
